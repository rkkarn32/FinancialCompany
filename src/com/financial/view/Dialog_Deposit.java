...
public class Dialog_Deposit extends JDialog{
	private AbstractFrm parentframe;
	...
	public Dialog_Deposit(AbstractFrm parent, String aaccnr)
	{
		super(parent);
		parentframe=parent;
		accnr=aaccnr;
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event)
	{
		...
		retVal = Integer.parseInt(JTextField_Deposit.getText());
        dispose();
	}
